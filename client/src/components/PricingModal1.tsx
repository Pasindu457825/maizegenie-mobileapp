              ...
              <View style={styles.freeCard}>
                <View style={styles.cardTop}>
                  ...
                  <View style={styles.perfectForBadge}>
                    ...
                    <Text style={styles.perfectForSubtext}>
                      {t.beginnerFarmers}
                    </Text>
                  </View>
                </View>
              ...
              >
                ...
                <View style={styles.cardTop}>
                  ...
                  <View style={styles.perfectForBadgeLight}>
                    <Text style={styles.perfectForTextLight}>
                      {t.perfectFor}
                    </Text>
                    <Text style={styles.perfectForSubtextLight}>
                      {t.seriousFarmers}
                    </Text>
                  </View>
                </View>
                ...
                <View style={styles.proAdvantagesHeader}>
                  ...
                  <Text style={styles.proAdvantagesText}>
                    {t.proAdvantages}
                  </Text>
                </View>
                ...
                <TouchableOpacity activeOpacity={0.8} onPress={onSelectPro}>
                  <LinearGradient
                    colors={["#10B981", "#059669"]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 1, y: 1 }}
  ...
  <View style={styles.proFeatureItem}>
    ...
    <Text
      style={[
        ...
        highlight && styles.proFeatureTextHighlight,
      ]}
    >
      {text}
    </Text>
