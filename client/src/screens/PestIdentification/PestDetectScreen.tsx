...
import { View, Text, Button, Image, ActivityIndicator, StyleSheet, Platform } from "react-native";
  ...
  return (
    <View style={styles.container}>
      ...
      {loading ? (
        ...
        imageUri && <Button title="Detect Pest" onPress={uploadAndDetect} color="#4CAF50" />
      )}
