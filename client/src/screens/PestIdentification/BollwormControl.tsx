...
export default function BollwormControl() {
  ...
  const preventionSteps: PreventionStep[] = useMemo(
    () => [
      ...
      {
        key: "step5",
        icon: <Leaf size={26} color="#78350f" />,
        title: {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>
          {language === "si"
            ? "Bollworm පාලන හා වැළැක්වීම"
            : "Bollworm Control & Prevention"}
        </Text>
      ...
      <View style={styles.modeRow}>
        ...
        >
          <Info size={16} color={!todoMode ? "#ffffff" : "#78350f"} />
        ...
        >
          <CalendarCheck size={16} color={todoMode ? "#ffffff" : "#78350f"} />
          <Text style={[styles.modeText, todoMode && styles.modeTextActive]}>
          ...
          <>
            <View style={styles.todoHeader}>
              ...
              <View style={styles.todoProgress}>
                <CheckCircle2 size={16} color="#78350f" />
