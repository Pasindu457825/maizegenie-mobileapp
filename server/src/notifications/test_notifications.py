...
def test_notifications_service():
    ...
    try:
        ...
        if response.data:
            ...
            print(f"⚠️  No notifications in database yet (this is OK)")
    except Exception as e:
    ...
    try:
        ...
        print(f"ℹ️  Supabase URL: {supabase.url if hasattr(supabase, 'url') else 'Not available'}")
        print(f"ℹ️  Attempting to verify Supabase is configured...")
    ...
    print("\n3️⃣  EXAMPLE FOR DIFFERENT NETWORKS:")
    ...
    print("\n4️⃣  IF SERVER IS ON SAME MACHINE:")
